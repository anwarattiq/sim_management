...
if ($action == "update_$module" || $action == "add_$module") {
    ...
    $balance                     = $mysqli->real_escape_string(stripslashes($_POST['balance']));
} else {
    $sim_number                  = '';
    $telecom_name                = '';
    $balance                     = '';
...
if ($action == "update_$module" && !empty($id)) {
    ...
    if (empty($telecom_name)) {
        $error_message = 'Telcom name is mandatory.';
    } else {

        $insert_row = $mysqli->query("INSERT INTO `$tbl_name`(sim_number, telecom_name, balance, publish) VALUES ('" . $sim_number . "', '" . $telecom_name . "', '" . $balance . "', '" . $publish . "'); ");
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <select class="form-control" name="telecom_name" id="telecom_name">
                                            <option value="admin" <?php if ($telecom_name == 'zain') { ?>selected="selected" <?php } ?>>Zain - 0780</option>
                                            <option value="manager" <?php if ($telecom_name == 'asiacell') { ?>selected="selected" <?php } ?>>Asia Cell - 0770</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <span class="help-block"><strong><span id="span_sim_number"><?php echo strlen($sim_number); ?></span></strong> &nbsp; - &nbsp; 11 characters (Format: 0773851234)</span>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-lg-3 control-label"><strong>Balance</strong> <span class="f_req">*</span></label>
                                    <div class="col-lg-9">
                                        <input name="balance" id="balance" value="<?php echo $balance; ?>" class="form-control" type="text">
                                    </div>
                                </div>
