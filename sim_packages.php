...
if ($action == "update_$module" && !empty($id)) {
    ...
    if (empty($package_name)) {
        $error_message = 'Package Name is mandatory.';
    } else if (checkDuplicateRow($tbl_name, 'package_name', $package_name)) {
        $error_message = 'Duplicate Package Name. Please enter different.';
    } else if (empty($amount)) {
        $error_message = 'Amount is mandatory.';
    } else {

        $insert_row = $mysqli->query("INSERT INTO `$tbl_name`(package_name, amount, publish) VALUES ('" . $package_name ."', '" . $amount . "', '" . $publish . "'); ");
                        ...
                        <div class="panel-heading">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <input name="package_name" id="package_name" value="<?php echo $package_name; ?>" class="form-control" type="text">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <input name="amount" id="amount" value="<?php echo $amount; ?>" class="form-control" type="text">
                                    </div>
                                </div>
